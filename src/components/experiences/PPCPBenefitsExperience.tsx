        ...
        >
          ...
          {settings.solutionsPage.elements.showDescription && (
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-8 max-w-6xl mx-auto leading-tight">
              A solução completa de pagamentos para empresas que querem crescer sem limites
            </h1>
          )}
        </motion.div>
          ...
          <Card className="bg-gradient-to-r from-blue-500/20 to-blue-400/20 border-blue-400/30">
            <CardContent className="text-center py-8">
              ...
              <p className="text-lg text-gray-300 mb-4">
                Integração facilitada com documentação completa e suporte técnico em português
              </p>
              <div className="text-sm text-blue-300">
                * Onboarding assistido disponível para todos os clientes
              </div>
            </CardContent>
          </Card>
        </motion.div>
        ...
        >
          <div className="max-w-2xl mx-auto mb-8">
            ...
            <p className="text-xl text-gray-300">
              Fale com nossos especialistas e descubra como o PayPal Complete Payments pode transformar sua operação
            </p>
          </div>
