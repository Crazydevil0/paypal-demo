  ...
  return (
    ...
    >
      <div className="relative z-10 w-full max-w-1440 mx-auto px-4 md:px-8 xl:px-16 py-12">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 max-w-6xl mx-auto leading-tight">
            Mais superpoderes para você!
          </h1>
          <p className="text-2xl md:text-3xl font-semibold text-blue-400 mb-8">
